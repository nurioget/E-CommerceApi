...
namespace E_commerce.Infrastructure.RedisCache
{
    public class RedisCacheService : IRedisCacheService
    {
        ...
        public async Task SetAsync<T>(string key, T value, DateTime? exirationTime = null)
        {
            TimeSpan timeUnitExpiration = exirationTime.Value - DateTime.Now;
